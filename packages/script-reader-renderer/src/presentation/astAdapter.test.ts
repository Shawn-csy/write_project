...
import { defaultMarkerConfigs, parseScreenplay } from '@write/script-engine';
import { buildPresentationDocumentFromAst } from './astAdapter';

describe('buildPresentationDocumentFromAst', () => {
  it('converts character+dialogue flow into speech events with speaker', () => {
    ...
    const doc = buildPresentationDocumentFromAst(ast);
  ...
  it('converts default #C + #D marker flow into speaker speech events', () => {
    ...
    const doc = buildPresentationDocumentFromAst(parsed.ast, {
