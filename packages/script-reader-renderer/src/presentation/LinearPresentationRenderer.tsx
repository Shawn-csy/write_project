...
import type { OrchestratedDocument, ScriptEvent, TrackConfig } from './index';
...
interface LinearPresentationRendererProps {
...
export const LinearPresentationRenderer = ({
  doc,
  fontSize = 14,
  lineHeight = 1.4,
  markerConfigs = [],
...
}: LinearPresentationRendererProps): React.JSX.Element => {
  ...
  return (
    <div className="space-y-1 px-3 py-2" data-presentation-mode="linear">
