...
import type { OrchestratedDocument, ScriptEvent } from './index';
...
interface TimelinePresentationRendererProps {
...
export const TimelinePresentationRenderer = ({
  doc,
  fontSize = 14,
  lineHeight = 1.4,
  markerConfigs = [],
...
}: TimelinePresentationRendererProps): React.JSX.Element => {
