...
import { buildPresentationTableExport, buildPresentationTableExportFromRenderedHtml } from './exportAdapter';
import { cloneDefaultLayoutConfig } from './defaultLayoutConfig';
import type { OrchestratedDocument } from './types';

describe('buildPresentationTableExport', () => {
  it('includes unassigned events as a dedicated column', () => {
    ...
    const out = buildPresentationTableExport(doc);
  ...
  it('builds styled table cells from rendered v2 HTML', () => {
    const out = buildPresentationTableExportFromRenderedHtml(`
      <div data-presentation-mode="columns">
        <div class="sticky">
          <div></div>
