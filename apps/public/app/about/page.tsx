      ...
      <PublicInfoDocument>
        ...
        <PublicInfoLead>
          ...
          <ul className="list-disc pl-5 space-y-2 text-foreground/90">
            ...
            <li><strong>創作工作室</strong>：登入後可使用台本編輯與管理功能。</li>
            <li><strong>專業編輯器</strong>：支援分場、角色標記、封面設計、匯出等功能。</li>
          </ul>
          <p>
            平台持續開發中，歡迎回報問題或建議。聯絡方式請見下方。
          </p>
        </PublicInfoLead>

        {/* Below fold — cards, update list, contact */}
        <PublicInfoBelowFold>
          ...
          <PublicInfoSection title="聯絡我們" description="有任何問題、建議或回報，歡迎聯繫。" icon="✉" card>
