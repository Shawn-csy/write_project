...
describe("buildReadPageTitle", () => {
  ...
  it("series with order 0", () => {
    ...
    expect(buildReadPageTitle(script)).toBe(
      "黑夜系列 設定／背景：測試台本｜Screenplay Reader"
    );
  });
