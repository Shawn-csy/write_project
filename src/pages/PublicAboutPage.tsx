...
export default function PublicAboutPage() {
    ...
    return (
        <div className="min-h-screen bg-background flex flex-col">
          ...
          <meta name="description" content="Screenplay Reader 是免費的台本線上閱讀平台，讓創作者輕鬆發布與分享劇本作品。" />
          <meta name="robots" content="index,follow" />
          <link rel="canonical" href="https://open-scripts.shawnup.com/about" />
          <meta property="og:title" content="關於｜Screenplay Reader" />
          <meta property="og:description" content="Screenplay Reader 是免費的台本線上閱讀平台，讓創作者輕鬆發布與分享劇本作品。" />
