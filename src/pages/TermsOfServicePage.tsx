...
export default function TermsOfServicePage() {
  return (
    <div className="min-h-screen bg-background text-foreground">
      <MetaTags titleName="Terms of Service" />
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <section className="mb-8">
          ...
          <p className="text-sm leading-relaxed text-muted-foreground">
            ...
            <strong>open-scripts.shawnup.com</strong>, you agree to be bound by these Terms of Service.
        ...
        <section className="mb-8">
          ...
          <p className="text-sm leading-relaxed text-muted-foreground">
            Screenplay Reader is a platform for writing, reading, and sharing screenplays and scripts.
            Features include script creation, public sharing, and export to Google Docs.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-sm leading-relaxed text-muted-foreground">
            ...
            you grant us a non-exclusive, royalty-free license to display that content on the Service.
            You are solely responsible for ensuring your content does not infringe third-party rights.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-sm leading-relaxed text-muted-foreground">
            ...
            behalf to create documents in your Google account. This access is governed by Google&rsquo;s
