      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <section className="mb-8">
          ...
          <p className="text-sm leading-relaxed text-muted-foreground">
            This Privacy Policy describes how Screenplay Reader (&ldquo;we&rdquo;, &ldquo;our&rdquo;, or &ldquo;us&rdquo;),
            operated at <strong>open-scripts.shawnup.com</strong>, collects, uses, and protects
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc list-inside text-sm text-muted-foreground space-y-1 mt-2">
            <li><code className="text-xs bg-muted px-1 py-0.5 rounded">https://www.googleapis.com/auth/documents</code> &mdash; to create and write Google Docs</li>
            <li><code className="text-xs bg-muted px-1 py-0.5 rounded">https://www.googleapis.com/auth/drive.file</code> &mdash; to save exported files to your Google Drive</li>
          </ul>
          <p className="text-sm leading-relaxed text-muted-foreground mt-3">
        ...
        <section className="mb-8">
          ...
          <p className="text-sm leading-relaxed text-muted-foreground">
            Your account data (email, display name, profile photo URL) is stored in Firebase Firestore,
            operated by Google LLC. We do not store Google Docs or Drive access tokens beyond the
            duration of the export request. We take reasonable precautions to protect your data, but
        ...
        <section className="mb-8">
          ...
          <p className="text-sm leading-relaxed text-muted-foreground">
            ...
            as required to operate the service (e.g., Firebase/Google infrastructure) or as required
            by law.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-sm leading-relaxed text-muted-foreground">
            ...
            You can revoke Google OAuth permissions at any time via your{" "}
            <a
