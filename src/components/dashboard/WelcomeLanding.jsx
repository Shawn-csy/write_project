            ...
            <div className="relative z-10 max-w-2xl text-center space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
                <div className="space-y-4">
                    <h1 className="text-4xl sm:text-5xl font-extrabold tracking-tight lg:text-6xl text-foreground">
                        {t("welcomeLanding.title")}
                    </h1>
                    <p className="text-xl text-muted-foreground max-w-lg mx-auto leading-relaxed">
                        {t("welcomeLanding.subtitleLine1")}<br />
                        {t("welcomeLanding.subtitleLine2")}
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full max-w-md mx-auto pt-4">
                    ...
                    >
                        ...
                        {t("welcomeLanding.startCreating")}
                    </Button>
                </div>
                ...
                <div className="pt-8 grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8 text-center text-sm text-muted-foreground/60 w-full max-w-lg mx-auto">
                    <div className="flex flex-col items-center gap-2">
                        ...
                        <span>{t("welcomeLanding.featureRead")}</span>
                    </div>
                     <div className="flex flex-col items-center gap-2">
                        <PenTool className="w-6 h-6 opacity-50" />
                        <span>{t("welcomeLanding.featureEdit")}</span>
                    </div>
                     <div className="flex flex-col items-center gap-2">
                        <Globe className="w-6 h-6 opacity-50" />
                        <span>{t("welcomeLanding.featureShare")}</span>
                    </div>
                </div>
            </div>
        </div>
