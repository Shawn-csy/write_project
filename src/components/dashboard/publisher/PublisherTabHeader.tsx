...
interface PublisherTabHeaderProps {
...
export function PublisherTabHeader({ title, description, actions = null, className = "" }: PublisherTabHeaderProps): React.JSX.Element {
    return (
